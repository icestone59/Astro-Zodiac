...
2. **ห้ามใช้ศัพท์เทคนิคโหราศาสตร์** ในข้อความวิเคราะห์
3. รายการใน List (เช่น identity_list, shadow_list) **ห้ามเขียนสั้นแค่วลี** แต่ต้องเขียนเป็นประโยคบรรยายพฤติกรรมและความรู้สึกที่ลงลึก ละเอียด 2-3 บรรทัดต่อข้อ

ตัวอย่างโครงสร้าง JSON:
{
  "executive_summary": "บรรยายสรุปภาพรวมตัวตน ความคาดหวัง ปมชีวิต และเป้าหมายการเติบโต 2 ย่อหน้าแน่นๆ",
  "identity_list": [
    "ภายนอกดูเป็นคนสงบนิ่ง สุภาพ และควบคุมอารมณ์ได้ดีเยี่ยม แต่ภายในกลับเป็นคนที่ตั้งมาตรฐานให้ตัวเองสูงมาก และมีแรงขับทะเยอทะยานที่ซ่อนอยู่ใต้ความเรียบง่าย",
    "ไม่ใช่คนชอบแสดงตัวหรือป่าวประกาศความสำเร็จ แต่ต้องการให้ผลงานและความตั้งใจจริงเป็นตัวพิสูจน์คุณค่า จึงมักทุ่มเททำงานหนักกว่าที่คนอื่นเห็นอยู่เสมอ",
    "มีความสามารถในการคิดวิเคราะห์ปัญหาซับซ้อน มองภาพระยะยาวได้เฉียบขาด จึงเหมาะกับงานเชิงวางระบบและนวัตกรรม"
  ],
  "identity_dev": "ลดความคาดหวังที่สมบูรณ์แบบลง และยอมรับว่าคุณค่าของคุณไม่ได้ลดลงแม้ในวันที่ผลลัพธ์ไม่เป็นไปตามแผน",
  "shadow_list": [
    "กลัวการทำให้คนอื่นผิดหวังมากกว่ากลัวความล้มเหลว ทำให้มักแบกรับความคาดหวังของผู้อื่นไว้บนบ่าโดยไม่ปฏิเสธ",
    "มีแนวโน้มดื้อเงียบและเก็บความเครียดไว้คนเดียว เมื่อถึงขีดจำกัดจะตัดขาดการติดต่อเพื่อถอยกลับมาฟื้นฟูพลังในพื้นที่ส่วนตัว"
  ],
  "shadow_dev": "ฝึกสื่อสารความรู้สึกตรงๆ และยอมรับความช่วยเหลือจากคนรอบข้าง การพักผ่อนไม่ใช่ความอ่อนแอแต่คือการรักษาพลังงานชีวิต"
}
"""
